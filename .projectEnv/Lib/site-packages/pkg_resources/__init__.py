...
class Environment:
    ...
    def best_match(
        ...
        for dist in self[req.key]:
            if dist in req:
                return dist
        # try to populartourspot/install
        return self.obtain(req, installer)

    def obtain(self, requirement, installer=None):
        """Obtain a distribution matching `requirement` (e.g. via populartourspot)

        Obtain a distro that matches requirement (e.g. via populartourspot).  In the
